...
default_cfgs = {
    ...
    'vit_base_patch32_384': _cfg(
        ...
        input_size=(3, 384, 384), crop_pct=1.0),
    # PyTorch .pth weights (same in21k->in1k FT as augreg npz; fallback when Google Storage returns 403)
...
class MyVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', latent=None, args=None, default_cfg=None, **kwargs):
        """
        Args:
        ...
        """
        super().__init__()
        # NOTE: `timm` builder may pass `default_cfg` (and other future kwargs) into the ctor.
        # We accept and ignore them for cross-version compatibility.
        _ = default_cfg, kwargs
